 ...
 * High-end cinematic hacker workstation matching holographic cinema AI command console.
 */
...
export const CommandCenter: React.FC = () => {
  ...
  const [playbackTime, setPlaybackTime] = useState(4523); // 01:15:23 in seconds
    ...
    if (isPlaying) {
      interval = setInterval(() => {
        setPlaybackTime(prev => {
          if (prev >= currentProject.durationSec) {
            setIsPlaying(false);
            return 0;
          }
          return prev + 1;
  ...
  return (
    <div className="h-[calc(100vh-3.5rem)] overflow-y-auto bg-[#02050f] text-slate-100 p-3.5 space-y-3.5 select-none font-sans bg-hud-grid">
      ...
      {/* ROW 1: Source + Active Scene Viewport + AI Analysis + Real-time Scan */}
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-3.5">
        
        {/* PANEL 1: MOVIE SOURCE (Col 2.5) */}
        <div className="xl:col-span-3 hud-panel rounded-lg p-3.5 border border-cyan-500/30 hud-corners flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2 mb-3">
              <div className="flex items-center space-x-2 text-xs font-tech font-bold text-cyan-300">
                <Film className="w-3.5 h-3.5 text-cyan-400" />
                <span className="tracking-wider">MOVIE SOURCE</span>
              </div>
              <span className="text-[10px] font-mono text-cyan-400/80 uppercase">INGEST // OK</span>
            </div>

            {/* Poster & details */}
            <div className="flex space-x-3 mb-3">
              <div className="relative w-20 h-28 shrink-0 rounded overflow-hidden border border-cyan-500/40 shadow-[0_0_10px_rgba(0,240,255,0.2)]">
                <img
              ...
              <div className="flex-1 min-w-0 space-y-1.5 text-xs">
                <div className="font-tech font-bold text-slate-100 truncate text-sm">
                  {currentProject.videoSourceUrl || 'Inception.mp4'}
                </div>
                <div className="text-[11px] font-mono text-cyan-400/80">
                  {currentProject.duration} • {currentProject.resolution}
                </div>
                <div className="flex flex-wrap gap-1">
                  {currentProject.genre.map((g, i) => (
            ...
            <div className="grid grid-cols-3 gap-1.5 pt-2 border-t border-cyan-500/20 text-center">
              {[
                { name: 'Video', done: true },
                { name: 'Audio', done: true },
                { name: 'Frames', done: true },
                { name: 'Analysis', done: true },
                { name: 'Story', done: true },
                ...
                <div key={idx} className="bg-[#060c18] border border-cyan-500/20 rounded p-1">
                  ...
                  <div className="text-[9.5px] font-tech text-slate-300">{step.name}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* PANEL 2: ACTIVE SCENE VIEWPORT WITH FACIAL RECOGNITION HUD (Col 5) */}
        <div className="xl:col-span-4 hud-panel rounded-lg p-3.5 border border-cyan-500/40 hud-corners flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2 mb-2 text-xs">
              <div className="font-tech font-bold text-cyan-300 flex items-center gap-2">
                ...
                <span>SCENE 042 | 01:14:32 - 01:16:08</span>
              </div>
              <span className="text-[10px] font-mono text-slate-400">FPS: 24.00</span>
            </div>
            ...
            <div className="relative aspect-video rounded overflow-hidden border border-cyan-500/40 bg-black shadow-[0_0_25px_rgba(0,240,255,0.15)] group">
              ...
              {/* HUD Facial Recognition Overlay Box matching screenshot */}
              <div className="absolute top-[20%] left-[38%] w-[32%] h-[55%] border-2 border-cyan-400/80 rounded pointer-events-none shadow-[0_0_15px_rgba(0,240,255,0.4)]">
                {/* Corner reticles */}
                ...
                <div className="absolute -bottom-7 right-0 bg-[#040a16]/95 border border-cyan-400/80 rounded px-2 py-0.5 text-[9px] font-mono text-cyan-200 whitespace-nowrap shadow-[0_0_10px_rgba(0,240,255,0.3)]">
                  <div className="font-bold text-cyan-300">LEONARDO DICAPRIO</div>
                  <div className="text-[8px] text-slate-400">Main Character • 98% Match</div>
                </div>
              </div>
              ...
              <div className="absolute bottom-0 inset-x-0 h-6 bg-gradient-to-t from-black/90 to-transparent flex items-end px-2 space-x-0.5 pointer-events-none opacity-80">
                {[15, 30, 60, 45, 90, 35, 75, 40, 85, 95, 30, 65, 80, 50, 70, 90, 40, 60, 85, 55, 35, 75, 90, 60, 45, 85, 30, 70, 95, 40].map((h, i) => (
                  <div
                    key={i}
            ...
            <div className="mt-2.5 space-y-1.5">
              <div className="flex items-center justify-between text-[11px] font-mono text-cyan-400">
                ...
                <span className="text-slate-400">{currentProject.duration}</span>
              </div>
              ...
              <div 
                ...
                onClick={(e) => {
                  ...
                  setPlaybackTime(Math.round(pct * currentProject.durationSec));
                  playHudClick();
                }}
              >
                <div
                  className="h-full bg-gradient-to-r from-cyan-500 to-blue-500"
                  style={{ width: `${(playbackTime / currentProject.durationSec) * 100}%` }}
                />
              </div>
              ...
              <div className="flex items-center justify-between pt-1">
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    onClick={() => {
                      playHudClick();
                      setPlaybackTime(prev => Math.min(currentProject.durationSec, prev + 10));
                    }}
                    className="p-1.5 rounded bg-slate-900 hover:bg-slate-800 text-slate-300 border border-slate-700 hover:border-cyan-500/40 cursor-pointer"
                  >
                ...
                <div className="flex items-center space-x-2 text-[10px] font-mono text-slate-400">
                  ...
                  <button className="p-1 rounded hover:bg-slate-800 hover:text-cyan-300 cursor-pointer">
        ...
        {/* PANEL 3: AI ANALYSIS SCORE & METRICS (Col 2.5) */}
        <div className="xl:col-span-2.5 hud-panel rounded-lg p-3.5 border border-cyan-500/30 hud-corners flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2 mb-3">
              <div className="flex items-center space-x-2 text-xs font-tech font-bold text-cyan-300">
              ...
              <span className="text-[10px] font-mono text-cyan-400/80">SCORE // 92%</span>
            </div>
            ...
            <div className="relative w-28 h-28 mx-auto my-2">
              <svg className="w-full h-full transform -rotate-90" viewBox="0 0 100 100">
                ...
                <circle
                  ...
                  strokeDashoffset={`${2 * Math.PI * 40 * (1 - currentProject.analysis.overallScore / 100)}`}
                  strokeLinecap="round"
                  fill="transparent"
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                <span className="text-2xl font-display font-black text-cyan-200">
                  {currentProject.analysis.overallScore}%
                </span>
            ...
            <div className="space-y-1.5 text-xs pt-2">
              {[
                { label: 'Characters', val: currentProject.analysis.charactersCount },
                { label: 'Key Events', val: currentProject.analysis.keyEventsCount },
                { label: 'Twists', val: currentProject.analysis.twistsCount },
                { label: 'Suspense Points', val: currentProject.analysis.suspensePointsCount },
                { label: 'Emotional Moments', val: currentProject.analysis.emotionalMomentsCount },
              ].map((m, idx) => (
        ...
        {/* PANEL 4: REAL-TIME SCAN & FRAME ANALYSIS (Col 2.5) */}
        <div className="xl:col-span-2.5 hud-panel rounded-lg p-3.5 border border-cyan-500/30 hud-corners flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2 mb-2">
              ...
              <span className="text-[10px] font-mono text-emerald-400 animate-pulse">● ACTIVE</span>
            </div>

            {/* Wireframe head scan simulation matching screenshot */}
            ...
            <div className="space-y-1 text-xs">
              ...
              {[
                { name: 'Leonardo DiCaprio', conf: 98 },
                { name: 'Joseph Gordon-Levitt', conf: 87 },
                { name: 'Elliot Page', conf: 72 },
                { name: 'Tom Hardy', conf: 64 },
                { name: 'Ken Watanabe', conf: 58 },
              ].map((c, i) => (
                <div key={i} className="flex items-center justify-between text-[10.5px]">
                  ...
                  <span className="font-mono text-cyan-300 font-bold">{c.conf}%</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="pt-2 border-t border-cyan-500/20">
            <div className="text-[10px] font-tech uppercase text-cyan-400/80 mb-1 flex items-center justify-between">
              ...
              <span className="font-mono text-[9px] text-slate-500">4 SCENES</span>
            </div>
      ...
      {/* ROW 2: Story Graph + Character Intelligence + AI Director + System Logs */}
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-3.5">
        
        {/* PANEL 5: STORY GRAPH (Col 3) */}
        <div className="xl:col-span-3 hud-panel rounded-lg p-3.5 border border-cyan-500/30 hud-corners">
          <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2 mb-2.5">
            ...
            <span className="text-[10px] font-mono text-cyan-400/80">9 NODES</span>
          </div>
          ...
          <div className="relative h-48 bg-[#030713] rounded border border-cyan-500/30 overflow-hidden flex items-center justify-center">
            <svg className="w-full h-full" viewBox="0 0 500 380">
              ...
              <text x="250" y="154" fill="#ffffff" fontSize="11" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">Cobb</text>

              {/* Sub Nodes */}
              <circle cx="120" cy="90" r="18" fill="#081427" stroke="#38bdf8" strokeWidth="1.5" />
              <text x="120" y="93" fill="#cbd5e1" fontSize="9" textAnchor="middle">Ariadne</text>

              <circle cx="380" cy="90" r="18" fill="#081427" stroke="#38bdf8" strokeWidth="1.5" />
              <text x="380" y="93" fill="#cbd5e1" fontSize="9" textAnchor="middle">Saito</text>

              <circle cx="420" cy="220" r="18" fill="#081427" stroke="#38bdf8" strokeWidth="1.5" />
              <text x="420" y="223" fill="#cbd5e1" fontSize="9" textAnchor="middle">Fischer</text>

              <circle cx="250" cy="270" r="20" fill="#2d1017" stroke="#ef4444" strokeWidth="1.8" />
              <text x="250" y="274" fill="#fca5a5" fontSize="10" fontWeight="bold" textAnchor="middle">Mal</text>
              ...
              <text x="180" y="323" fill="#e9d5ff" fontSize="9" textAnchor="middle">Dreams</text>

              <circle cx="360" cy="320" r="17" fill="#081427" stroke="#10b981" strokeWidth="1.5" />
              <text x="360" y="323" fill="#a7f3d0" fontSize="9" textAnchor="middle">Reality</text>
            </svg>
          </div>

          {/* Graph Legend */}
          <div className="grid grid-cols-2 gap-1.5 pt-2 text-[10px] font-mono text-slate-400">
            <div>Characters: <strong className="text-cyan-300">12</strong></div>
            <div>Locations: <strong className="text-cyan-300">8</strong></div>
            <div>Events: <strong className="text-cyan-300">38</strong></div>
            <div>Relationships: <strong className="text-cyan-300">26</strong></div>
          </div>
        </div>

        {/* PANEL 6: CHARACTER INTELLIGENCE (Col 3.5) */}
        <div className="xl:col-span-3.5 hud-panel rounded-lg p-3.5 border border-cyan-500/30 hud-corners">
          <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2 mb-2.5">
            <div className="flex items-center space-x-2 text-xs font-tech font-bold text-cyan-300">
              <User className="w-3.5 h-3.5 text-cyan-400" />
              <span className="tracking-wider">CHARACTER INTELLIGENCE</span>
            </div>
            <span className="text-[10px] font-mono text-cyan-400/80">ROLES // 5 PRIMARY</span>
          </div>
          ...
          <div className="grid grid-cols-5 gap-1.5">
            {currentProject.characters.map((c) => (
              <div
                key={c.id}
                className="bg-[#050b18] border border-cyan-500/30 rounded p-1.5 flex flex-col items-center text-center group hover:border-cyan-400 transition-colors"
              >
                <div className="relative w-11 h-11 rounded overflow-hidden border border-cyan-400/50 mb-1">
                  <img src={c.avatar} alt={c.name} className="w-full h-full object-cover" />
                  <span className="absolute bottom-0 right-0 bg-black/90 text-[7.5px] font-mono text-cyan-300 px-0.5">
                    {c.confidence}%
                  </span>
                </div>
                <div className="text-[10px] font-tech font-bold text-slate-100 truncate w-full">{c.name}</div>
                <div className="text-[8px] font-mono text-cyan-400/80 truncate w-full uppercase">{c.role}</div>
                <div className="text-[7.5px] text-slate-400 truncate w-full mt-0.5">{c.archetype.split('/')[0]}</div>
              </div>
            ))}
          </div>

          {/* Quick quote highlight */}
          <div className="mt-3 p-2 rounded bg-cyan-950/40 border border-cyan-500/20 text-[10.5px] text-cyan-200 italic font-serif">
            "{currentProject.characters[0]?.keyQuote || 'An idea is like a virus. Resilient. Highly contagious.'}"
        ...
        {/* PANEL 7: AI DIRECTOR PROMPTS (Col 3) */}
        <div className="xl:col-span-3 hud-panel rounded-lg p-3.5 border border-cyan-500/30 hud-corners flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2 mb-2.5">
              <div className="flex items-center space-x-2 text-xs font-tech font-bold text-cyan-300">
                <Sparkles className="w-3.5 h-3.5 text-cyan-400" />
                <span className="tracking-wider">AI DIRECTOR</span>
              </div>
              ...
              {directorPrompts.map((p, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-1.5 rounded border text-[10.5px] flex items-center justify-between transition-colors cursor-pointer ${
                      isApplied
          ...
          <button
            ...
            className={`w-full mt-2.5 py-1.5 rounded text-xs font-tech font-bold tracking-wider uppercase border transition-all cursor-pointer ${
        ...
        {/* PANEL 8: SYSTEM LOGS TERMINAL (Col 2.5) */}
        <div className="xl:col-span-2.5 hud-panel rounded-lg p-3.5 border border-cyan-500/30 hud-corners flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2 mb-2">
              <div className="flex items-center space-x-2 text-xs font-tech font-bold text-cyan-300">
                <TerminalIcon className="w-3.5 h-3.5 text-cyan-400" />
                <span className="tracking-wider">SYSTEM LOGS</span>
              </div>
            ...
            <div
              ref={terminalRef}
              className="h-44 overflow-y-auto font-terminal text-[10px] space-y-1 text-slate-400 bg-[#02050f] p-2 rounded border border-cyan-500/20"
            >
      ...
      {/* ROW 3: Script Studio Breakdown + AI First Cut Multi-track Timeline + Quality & Export */}
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-3.5">
        
        {/* PANEL 9: SCRIPT BREAKDOWN (Col 3.5) */}
        <div className="xl:col-span-3.5 hud-panel rounded-lg p-3.5 border border-cyan-500/30 hud-corners">
          <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2 mb-2.5">
            <div className="flex items-center space-x-2 text-xs font-tech font-bold text-cyan-300">
              <FileText className="w-3.5 h-3.5 text-cyan-400" />
              <span className="tracking-wider">SCRIPT ({currentProject.script.targetDurationSec / 60}:00 target)</span>
            </div>
            <button
            ...
            {currentProject.script.segments.map((seg) => (
              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="flex items-center space-x-2">
                    <span className="text-[10px] font-mono text-cyan-400 font-bold">{seg.timestampTarget.split(' - ')[0]}</span>
        ...
        {/* PANEL 10: AI FIRST CUT TIMELINE (Col 5.5) */}
        <div className="xl:col-span-5.5 hud-panel rounded-lg p-3.5 border border-cyan-500/40 hud-corners flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2 mb-2">
              <div className="flex items-center space-x-2.5 text-xs font-tech font-bold text-cyan-300">
                ...
                <span className="text-cyan-400 font-mono">24:32</span>
                <span className="text-[10px] font-mono text-slate-500">(Original: {currentProject.duration})</span>
              </div>
            ...
            <div className="space-y-1 bg-[#02050e] border border-cyan-500/20 rounded p-1.5 font-mono text-[9px]">
              {currentProject.timeline.tracks.map((track) => (
                <div key={track.id} className="flex items-center space-x-2">
                  <span className="w-14 truncate text-slate-400 uppercase font-tech text-[10px]">
                    {track.name}
                  </span>
                  <div className="flex-1 h-4 bg-slate-950/80 rounded border border-slate-800 relative overflow-hidden flex items-center">
                    {track.clips.map((clip) => {
                      const widthPct = Math.max(5, (clip.duration / currentProject.timeline.totalDuration) * 100);
                      return (
                        <div
                          key={clip.id}
          ...
          <div className="pt-2 flex items-center justify-between">
            ...
            >
              <span>OPEN ADVANCED TIMELINE WORKSTATION</span>
              <ChevronRight className="w-3.5 h-3.5" />
            </button>
            <button
              onClick={() => navigateTo('pro-editor')}
              className="px-3 py-1 bg-cyan-950/60 hover:bg-cyan-900/80 border border-cyan-500/40 rounded text-xs font-tech text-cyan-200 cursor-pointer"
            >
              LAUNCH PRO EDITOR
            </button>
          </div>
        ...
        {/* PANEL 11: QUALITY CHECK & EXPORT (Col 3) */}
        <div className="xl:col-span-3 hud-panel rounded-lg p-3.5 border border-cyan-500/30 hud-corners flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-cyan-500/20 pb-2 mb-2.5">
              <div className="flex items-center space-x-2 text-xs font-tech font-bold text-cyan-300">
            ...
            <div className="space-y-1 text-xs">
              {[
                { name: 'Narration Sync', pct: currentProject.analysis.narrationSyncScore },
                { name: 'Scene Matching', pct: currentProject.analysis.sceneMatchingScore },
                { name: 'Audio Stems', pct: currentProject.analysis.audioScore },
                { name: 'Subtitles Accuracy', pct: currentProject.analysis.subtitlesScore },
                { name: 'Pacing Cadence', pct: currentProject.analysis.pacingScore },
                { name: 'Continuity Flow', pct: currentProject.analysis.continuityScore },
              ].map((q, idx) => (
          ...
          <div className="pt-2 border-t border-cyan-500/20 space-y-2">
            ...
            <div className="flex items-center justify-between text-[10px] font-mono text-slate-400">
              ...
              <span className="text-cyan-400">SRT + Thumbnails Ready</span>
            </div>
          </div>
        </div>
      ...
      {/* ROW 4: JARVIS AI ASSISTANT COMMAND CONSOLE BAR */}
        ...
        <form onSubmit={handleCommandSubmit} className="flex-1 w-full max-w-2xl flex items-center space-x-2">
          <div className="relative flex-1">
            <input
              ...
              placeholder="Tell The Devil's Eye what you want... (e.g. 'Build the first cut', 'Make the opening more suspenseful', 'Create 5 shorts')"
