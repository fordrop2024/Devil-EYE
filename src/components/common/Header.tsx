  ...
  return (
    <header className="h-14 bg-[#040814]/90 border-b border-cyan-500/20 backdrop-blur-md px-4 flex items-center justify-between z-30 select-none relative">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-2 bg-slate-900/80 border border-emerald-500/40 rounded-full px-3 py-1 shadow-[0_0_12px_rgba(16,185,129,0.15)]">
          <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse shadow-[0_0_8px_#34d399]" />
          <span className="text-[11px] font-tech font-semibold tracking-wider text-emerald-300">
            SYSTEM {systemStatus}
          </span>
        </div>
