...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-56 bg-[#030611] border-r border-cyan-500/20 flex flex-col justify-between select-none relative z-20 shrink-0 h-[calc(100vh-3.5rem)]">
      {/* Top Logo and Identity */}
      <div>
        <div className="px-3 py-3.5 border-b border-cyan-500/15 flex items-center space-x-2.5">
